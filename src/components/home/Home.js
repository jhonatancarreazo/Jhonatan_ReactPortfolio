...
export default function Home({innerRef}) {
   ...
   return (
      <Box ref={innerRef} component={'main'} display={'flex'} flexDirection={{xs: 'column', md: 'row'}} alignItems={'center'}
         ...
         <Box className={classNames(Style.avatar, Style.shadowed)} alt={'Jhonatan Carreazo - Frontend Web Developer'} style={{background: info.gradient}} component={'img'} src={me} width={{xs: '35vh', md: '40vh'}}
